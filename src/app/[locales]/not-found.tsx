    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
            <div className="max-w-md w-full text-center">
                ...
                <h1 className="text-6xl font-bold text-gray-900 mb-4">{t('heading')}</h1>

                <h2 className="text-2xl font-semibold text-gray-700 mb-4">{t('subheading')}</h2>
                ...
                <div className="mt-12">
                    <p className="text-sm text-gray-500 mb-4">{t('lookingFor')}</p>
